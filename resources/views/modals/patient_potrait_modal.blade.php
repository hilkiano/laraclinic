    ...
    <div class="modal-dialog modal-lg modal-fullscreen-lg-down">
        <div class="modal-content">
                ...
                <div class="row gy-3">
                    <div class="col-12 d-grid">
                        <div class="form-check form-switch">
                            <input autocomplete="off" class="form-check-input" type="checkbox" role="switch" id="startCameraSwitch">
            ...
            <div class="modal-footer">
                ...
                <button id="takePotraitBtn" class="btn btn-primary disabled">Take Potrait</button>
            </div>
        </div>
    </div>
</div>
...
<div id="cropperPotraitModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg modal-fullscreen-lg-down">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="cropperPotraitCloseBtn">Retake Photo</button>
                <button type="button" class="btn btn-primary" id="cropperPotraitSubmitBtn" data-id="{{ array_key_exists('patient', $data) ? $data['patient']->id : '' }}">Crop and Submit</button>
            </div>
        </div>
    </div>
</div>